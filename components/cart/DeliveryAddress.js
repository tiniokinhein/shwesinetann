...
const DeliveryAddress = ({ addressStatus, setAddressStatus, setStatus, status, info }) => {
    ...
    const { address: data } = useSelector(state => state.cart)
