...
const Login = () => {
        ...
        >
            ...
            <div className='flex flex-col mb-7 relative'>
                ...
                <Link href='/account/forgot-password' legacyBehavior>
                    <a className='ml-auto text-200 text-[12px] mt-2 font-light float-right hover:text-200/80 transition-all hover:transition-all'>
                        Forgot password?
                    </a>
                </Link>

                {
                    state.pwd.length >= 1 && (
                        <button 
                            className='text-black absolute right-[20px] bottom-[40px] z-10'
                            onClick={(e) => {
                                e.preventDefault()
    ...
    return (
        <>
            <Head>
                <title>Sign In | Shwe Sine Tann</title>
            ...
            <div className={`lg:flex lg:flex-row lg:flex-wrap lg:h-[100vh] lg:min-h-[600px] bg-white`}>
                ...
                <div className={`lg:w-1/2 flex flex-col items-center justify-center relative py-20 lg:py-0`}>
                    ...
                    <AuthHeaderLayout
                        title='Sign In'
                        info='Please sign in to continue our app'
                    />
                    ...
                    <div className={`mt-5 w-4/5 lg:w-3/5`}>
                        ...
                        <button 
                            className='flex flex-row items-center justify-center normal-case w-full h-[48px] mt-3 rounded-[11px] border border-400 text-[12px] text-black px-5'
                            onClick={() => {}}
                        >
                            <img 
                                src='/assets/social/gg.png'
                                alt=''
                                className='w-[18px] mr-1.5'
                            /> Sign in with Google
                        </button>
                        <button 
                            className='flex flex-row items-center justify-center normal-case w-full h-[48px] mt-3 rounded-[11px] border border-400 text-[12px] text-black px-5'
