        ...
        >
            <div className='2xl:container px-5 mx-auto py-10'>
                ...
                <Tabs className='react-tabs mt-3'>
                    <TabList className='bg-500 border-0 mb-10 rounded-lg shop-tab'>
                        <Tab
                            className={`react-tabs__tab ${playfair.className} !text-black/80 !px-10 !py-3 !border-0 !bottom-0 !rounded-md`}>
                            Product
                        </Tab>
                        <Tab
                            className={`react-tabs__tab ${playfair.className} !text-black/80 !px-10 !py-3 !border-0 !bottom-0 !rounded-md`}>
...
ShopDetail.getInitialProps = async (context) => {
